  ...
  return (
    <div className="flex flex-col space-y-1">
      <label className="text-sm font-medium text-fg-neutral-secondary">
        {label}{" "}
        <span className="text-fg-error-primary">{required ? "*" : ""}</span>
      </label>
      ...
      <div className="w-full flex flex-col space-y-2 mt-2 font-normal text-base">
        {file ? (
          ...
          <div
            className={`border rounded-sm px-3 py-[7px] w-full flex justify-between items-center font-normal text-base border-action-border-neutral-light_normal ${
              disabled
                ? "cursor-not-allowed text-action-fg-base-white"
                : "cursor-pointer text-fg-neutral-primary-light focus:outline-primary hover:border-action-border-neutral-light_normal"
            }`}
          >
            <label
              ...
              className={`flex items-center justify-between w-full ${
                disabled
                  ? "cursor-not-allowed text-action-fg-base-white"
                  : "cursor-pointer text-fg-neutral-tertiary"
              }`}
            >
              <input
                type="file"
              ...
              <span
                className={`${
                  disabled
                    ? "cursor-not-allowed text-action-base-white"
